...
def run_VIPUR_local( pdb_filename , variants_filename , prediction_filename = '' , out_path = '' ,
...
#        debug_time.append( ('relax' , time.time()) )
        ...
        for i in variants.keys():
            ...
            sys.stdout.flush()
            relax_filename = run_rosetta_relax( variant_structure )    # old method
...
def run_VIPUR_transition( pdb_filename , variants_filename , prediction_filename = '' , out_path = '' ,
...
#        print pdb_filename , pdb_filenames , os.getcwd() , variants_filename , pdb_filenames[0][:-4] + variants_filename
        ...
        for i in pdb_filenames:
            ...
            run_VIPUR_local( i[0] , i[1] )
        
        exit()    # so it does not error-out after the loop
    
        
    run_VIPUR_local( pdb_filename , variants_filename ,
